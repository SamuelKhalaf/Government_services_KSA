...
@section('title', __('document-types.edit'))

@section('content')
<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
    <div class="d-flex flex-column flex-column-fluid" id="kt_app_content">
        <div class="d-flex flex-column flex-column-fluid" id="kt_app_content_container">
            <div class="container-fluid">
                <!-- Page Header -->
                <div class="card mb-5 mb-xl-10">
                    <div class="card-header border-0">
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">{{ __('document-types.edit') }}: {{ $type->name_en }}</h3>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.document-types.update', $type) }}" method="POST" id="kt_document_type_form">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('name_en') is-invalid @enderror" 
                                           name="name_en" value="{{ old('name_en', $type->name_en) }}" required>
                                    @error('name_en')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('name_ar') is-invalid @enderror" 
                                           name="name_ar" value="{{ old('name_ar', $type->name_ar) }}" required>
                                    @error('name_ar')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                               name="code" id="document_type_code" value="{{ old('code', $type->code) }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror" name="category" required>
                                        ...
                                        <option value="employee" {{ old('category', $type->category) === 'employee' ? 'selected' : '' }}>{{ __('document-types.employee') }}</option>
                                        <option value="company" {{ old('category', $type->category) === 'company' ? 'selected' : '' }}>{{ __('document-types.company') }}</option>
                                    </select>
                                    @error('category')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('entity_type') is-invalid @enderror" name="entity_type" required>
                                        ...
                                        <option value="saudi" {{ old('entity_type', $type->entity_type) === 'saudi' ? 'selected' : '' }}>{{ __('document-types.saudi') }}</option>
                                        <option value="expat" {{ old('entity_type', $type->entity_type) === 'expat' ? 'selected' : '' }}>{{ __('document-types.expat') }}</option>
                                        <option value="both" {{ old('entity_type', $type->entity_type) === 'both' ? 'selected' : '' }}>{{ __('document-types.both') }}</option>
                                    </select>
                                    @error('entity_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('reminder_days_before') is-invalid @enderror" 
                                           ...
                                           value="{{ old('reminder_days_before', $type->reminder_days_before) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                              name="description_en" rows="2">{{ old('description_en', $type->description_en) }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                              name="description_ar" rows="2">{{ old('description_ar', $type->description_ar) }}</textarea>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="quick_document_number" onchange="toggleQuickField('document_number')"
                                                       {{ $type->custom_fields && collect($type->custom_fields)->contains('key', 'document_number') ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="quick_issue_date" onchange="toggleQuickField('issue_date')"
                                                       {{ $type->custom_fields && collect($type->custom_fields)->contains('key', 'issue_date') ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="quick_expiry_date" onchange="toggleQuickField('expiry_date')"
                                                       {{ $type->custom_fields && collect($type->custom_fields)->contains('key', 'expiry_date') ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="quick_place_of_issue" onchange="toggleQuickField('place_of_issue')"
                                                       {{ $type->custom_fields && collect($type->custom_fields)->contains('key', 'place_of_issue') ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="quick_notes" onchange="toggleQuickField('notes')"
                                                       {{ $type->custom_fields && collect($type->custom_fields)->contains('key', 'notes') ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="quick_renewal_notes" onchange="toggleQuickField('renewal_notes')"
                                                       {{ $type->custom_fields && collect($type->custom_fields)->contains('key', 'renewal_notes') ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="quick_document_file" onchange="toggleQuickField('document_file')"
                                                       {{ $type->custom_fields && collect($type->custom_fields)->contains('key', 'document_file') ? 'checked' : '' }}>
                                ...
                                <div class="col-12">
                                    ...
                                    <div id="custom-fields-container">
                                        @if($type->custom_fields && count($type->custom_fields) > 0)
                                            @php
                                                $quickFieldKeys = ['document_number', 'issue_date', 'expiry_date', 'place_of_issue', 'notes', 'renewal_notes', 'document_file'];
                                                $nonQuickFields = collect($type->custom_fields)->reject(function($field) use ($quickFieldKeys) {
                                                    return in_array($field['key'] ?? '', $quickFieldKeys);
                                                });
                                            @endphp
                                            @if($nonQuickFields->count() > 0)
                                                @foreach($nonQuickFields as $index => $field)
                                                    @php $fieldIndex = (int)$index + 1; @endphp
                                                <div class="card mb-4" id="custom_field_{{ $fieldIndex }}">
                                                    <div class="card-header">
                                                        <div class="card-title">
                                                            <h5 class="fw-bold m-0">{{ __('document-types.custom_field') }} #{{ $fieldIndex }}</h5>
                                </div>
                                                        <div class="card-toolbar d-flex align-items-center gap-2">
                                    <div class="form-check form-switch">
                                                                <input class="form-check-input" type="checkbox" name="custom_fields[{{ $fieldIndex }}][required]" 
                                                                       value="1" {{ old('custom_fields.'.($fieldIndex).'.required', $field['required'] ?? false) ? 'checked' : '' }}>
                                                                <label class="form-check-label">
                                                                    {{ __('document-types.required_field') }}
                                        </label>
                                                            </div>
                                                            <button type="button" class="btn btn-sm btn-light-danger" onclick="removeCustomField('custom_field_{{ $fieldIndex }}')">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row g-3">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" name="custom_fields[{{ $fieldIndex }}][name_en]" 
                                                                       value="{{ old('custom_fields.'.($fieldIndex).'.name_en', $field['name_en']) }}" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label required">{{ __('document-types.field_name_ar') }}</label>
                                                                <input type="text" class="form-control" name="custom_fields[{{ $fieldIndex }}][name_ar]" 
                                                                       value="{{ old('custom_fields.'.($fieldIndex).'.name_ar', $field['name_ar']) }}" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label required">{{ __('document-types.field_key') }}</label>
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" name="custom_fields[{{ $fieldIndex }}][key]" 
                                                                           id="custom_field_key_{{ $fieldIndex }}" value="{{ old('custom_fields.'.($fieldIndex).'.key', $field['key']) }}" required 
                                                                           placeholder="e.g., passport_number">
                                                                    <button type="button" class="btn btn-light-primary" onclick="generateCustomFieldKey({{ $fieldIndex }})" title="{{ __('document-types.generate_key') }}">
                                                                        <i class="fa fa-magic"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                ...
                                                                <select class="form-select" name="custom_fields[{{ $fieldIndex }}][type]" required onchange="toggleFieldOptions('custom_field_{{ $fieldIndex }}')">
                                                                    <option value="">{{ __('document-types.select_field_type') }}</option>
                                                                    <option value="text" {{ old('custom_fields.'.($fieldIndex).'.type', $field['type']) === 'text' ? 'selected' : '' }}>{{ __('document-types.text') }}</option>
                                                                    <option value="number" {{ old('custom_fields.'.($fieldIndex).'.type', $field['type']) === 'number' ? 'selected' : '' }}>{{ __('document-types.number') }}</option>
                                                                    <option value="email" {{ old('custom_fields.'.($fieldIndex).'.type', $field['type']) === 'email' ? 'selected' : '' }}>{{ __('document-types.email') }}</option>
                                                                    <option value="date" {{ old('custom_fields.'.($fieldIndex).'.type', $field['type']) === 'date' ? 'selected' : '' }}>{{ __('document-types.date') }}</option>
                                                                    <option value="file" {{ old('custom_fields.'.($fieldIndex).'.type', $field['type']) === 'file' ? 'selected' : '' }}>{{ __('document-types.file') }}</option>
                                                                    <option value="select" {{ old('custom_fields.'.($fieldIndex).'.type', $field['type']) === 'select' ? 'selected' : '' }}>{{ __('document-types.select') }}</option>
                                                                    <option value="textarea" {{ old('custom_fields.'.($fieldIndex).'.type', $field['type']) === 'textarea' ? 'selected' : '' }}>{{ __('document-types.textarea') }}</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label">{{ __('document-types.placeholder_en') }}</label>
                                                                <input type="text" class="form-control" name="custom_fields[{{ $fieldIndex }}][placeholder_en]" 
                                                                       value="{{ old('custom_fields.'.($fieldIndex).'.placeholder_en', $field['placeholder_en'] ?? '') }}">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label">{{ __('document-types.placeholder_ar') }}</label>
                                                                <input type="text" class="form-control" name="custom_fields[{{ $fieldIndex }}][placeholder_ar]" 
                                                                       value="{{ old('custom_fields.'.($fieldIndex).'.placeholder_ar', $field['placeholder_ar'] ?? '') }}">
                                                            </div>
                                                            <div class="col-12" id="options_custom_field_{{ $fieldIndex }}" style="display: {{ old('custom_fields.'.($fieldIndex).'.type', $field['type']) === 'select' ? 'block' : 'none' }};">
                                                                <label class="form-label">{{ __('document-types.select_options') }}</label>
                                                                <div class="options-container">
                                                                    @if(isset($field['options']) && is_array($field['options']))
                                                                        @foreach($field['options'] as $optIndex => $option)
                                                                            <div class="input-group mb-2">
                                                                                <input type="text" class="form-control" placeholder="{{ __('document-types.option_value') }}" 
                                                                                       name="custom_fields[{{ $fieldIndex }}][options][value][]" value="{{ $option['value'] ?? '' }}">
                                                                                <input type="text" class="form-control" placeholder="{{ __('document-types.option_label_en') }}" 
                                                                                       name="custom_fields[{{ $fieldIndex }}][options][label_en][]" value="{{ $option['label_en'] ?? '' }}">
                                                                                <input type="text" class="form-control" placeholder="{{ __('document-types.option_label_ar') }}" 
                                                                                       name="custom_fields[{{ $fieldIndex }}][options][label_ar][]" value="{{ $option['label_ar'] ?? '' }}">
                                                                    ...
                                                                    @else
                                                                        <div class="input-group mb-2">
                                                                            <input type="text" class="form-control" placeholder="{{ __('document-types.option_value') }}" name="custom_fields[{{ $fieldIndex }}][options][value][]">
                                                                            <input type="text" class="form-control" placeholder="{{ __('document-types.option_label_en') }}" name="custom_fields[{{ $fieldIndex }}][options][label_en][]">
                                                                            <input type="text" class="form-control" placeholder="{{ __('document-types.option_label_ar') }}" name="custom_fields[{{ $fieldIndex }}][options][label_ar][]">
                                                                            <button type="button" class="btn btn-light-danger" onclick="removeOption(this)">
                                                                                <i class="fa fa-trash"></i>
                                                                            </button>
                                                                        </div>
                                                                ...
                                                                <button type="button" class="btn btn-light-primary btn-sm" onclick="addOption('custom_field_{{ $fieldIndex }}')">
                            ...
                            <div class="d-flex justify-content-end mt-8">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    ...
                                    {{ __('document-types.update_document_type') }}
                                </button>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @php
            $quickFieldKeys = ['document_number', 'issue_date', 'expiry_date', 'place_of_issue', 'notes', 'renewal_notes', 'document_file'];
            $nonQuickFields = $type->custom_fields ? collect($type->custom_fields)->reject(function($field) use ($quickFieldKeys) {
                return in_array($field['key'] ?? '', $quickFieldKeys);
            }) : collect();
        @endphp
        let fieldCounter = {{ $nonQuickFields->count() }};
        
        // Add quick field as hidden inputs
        window.addQuickFieldInputs = function(fieldData) {
            const form = document.getElementById('kt_document_type_form');
            const containerId = `quick_field_${fieldData.key}`;
        ...
        // Initialize quick fields on page load
        function initializeQuickFields() {
            const quickFieldKeys = ['document_number', 'issue_date', 'expiry_date', 'place_of_issue', 'notes', 'renewal_notes', 'document_file'];
            
            quickFieldKeys.forEach(fieldKey => {
                const checkbox = document.getElementById(`quick_${fieldKey}`);
                if (checkbox && checkbox.checked) {
                    // Add hidden inputs for pre-checked quick fields
                    addQuickFieldInputs(quickFields[fieldKey]);
                }
            });
        }
        
        // Initialize quick fields
        initializeQuickFields();
