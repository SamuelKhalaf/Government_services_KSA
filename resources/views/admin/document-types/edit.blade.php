                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                           name="code" value="{{ old('code', $type->code) }}" required>
                                    @error('code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                           name="sort_order" value="{{ old('sort_order', $type->sort_order) }}" min="0">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="requires_expiry_date" 
                                               id="requires_expiry_date" value="1" 
                                               {{ old('requires_expiry_date', $type->requires_expiry_date) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="requires_file_upload" 
                                               id="requires_file_upload" value="1" 
                                               {{ old('requires_file_upload', $type->requires_file_upload) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="has_auto_reminder" 
                                               id="has_auto_reminder" value="1" 
                                               {{ old('has_auto_reminder', $type->has_auto_reminder) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                                           name="icon" value="{{ old('icon', $type->icon) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror" 
                                           name="color" value="{{ old('color', $type->color ?? '#5E6278') }}">
                                    @error('color')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                              name="description_en" rows="3">{{ old('description_en', $type->description_en) }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                              name="description_ar" rows="3">{{ old('description_ar', $type->description_ar) }}</textarea>
