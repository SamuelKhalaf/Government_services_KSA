...
@section('title', __('packages.add_package'))
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{ __('packages.add_package') }}</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title-->
                    ...
                    <div class="card-body pt-0">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-10 fv-row">
                                ...
                                <input type="text" name="name" class="form-control mb-2" placeholder="{{ __('packages.placeholders.name') }}" value="{{ old('name') }}" />
                                @error('name')
                            ...
                            <div class="col-md-6 mb-10 fv-row">
                                ...
                                <div class="input-group">
                                    <input type="number" name="price" class="form-control" placeholder="{{ __('packages.placeholders.price') }}" value="{{ old('price') }}" step="0.01" min="0" />
                            ...
                            <div class="col-md-6 mb-10 fv-row">
                                ...
                                <div class="input-group">
                                    <input type="number" name="duration" class="form-control" placeholder="{{ __('packages.placeholders.duration') }}" value="{{ old('duration') }}" min="1" />
                            ...
                            <div class="col-md-6 mb-10 fv-row">
                                ...
                                <input type="number" name="max_employees" class="form-control mb-2" placeholder="{{ __('packages.placeholders.max_employees') }}" value="{{ old('max_employees') }}" min="1" />
                            ...
                            <div class="col-md-6 mb-10 fv-row">
                                ...
                                <input type="number" name="max_employee_documents" class="form-control mb-2" placeholder="{{ __('packages.placeholders.max_employee_documents') }}" value="{{ old('max_employee_documents') }}" min="1" />
                            ...
                            <div class="col-md-6 mb-10 fv-row">
                                ...
                                <input type="number" name="max_company_documents" class="form-control mb-2" placeholder="{{ __('packages.placeholders.max_company_documents') }}" value="{{ old('max_company_documents') }}" min="1" />
                            ...
                            <div class="col-12 mb-10 fv-row">
                                ...
                                <textarea name="description" class="form-control mb-2" rows="4" placeholder="{{ __('packages.placeholders.description') }}">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
...
<script>
    ...
    // Class definition
    var KTPackageCreate = function () {
        // Private functions
        var initValidation = function () {
            // Init form validation rules. For more info check the FormValidation plugin's official documentation:https://formvalidation.io/
            var form = document.getElementById('kt_package_create_form');
            ...
            const submitButton = document.getElementById('kt_package_create_submit');
