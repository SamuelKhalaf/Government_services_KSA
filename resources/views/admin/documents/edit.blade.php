        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <!--begin::Form-->
                    <form id="kt_document_form" class="form" action="{{ route('admin.employees.documents.update', [$employee, $document]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <!--begin::Card body-->
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            <a href="{{ route('admin.employees.documents.show', [$employee, $document]) }}" class="btn btn-light btn-active-light-primary me-2">
                                @lang('common.cancel')
                            </a>
