            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="card-title fs-3 fw-bold">
                        {{ __('companies.edit_document') }} - {{ (app()->getLocale() === 'ar' ? $document->documentType->name_ar : $document->documentType->name_en) ?? $document->document_type_id }}
                ...
                <!--begin::Form-->
                <form id="kt_company_document_form" class="form" action="{{ route('admin.companies.documents.update', [$company, $document]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!--begin::Card body-->
                                    ...
                                    <div class="col-md-6 fv-row">
                                        <div class="form-check form-switch form-check-custom form-check-solid">
                                            <input class="form-check-input" type="checkbox" name="enable_reminder"
                                                   id="enable_reminder" value="1" @checked(old('enable_reminder', $document->enable_reminder)) />
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <a href="{{ route('admin.companies.documents.show', [$company, $document]) }}" class="btn btn-light btn-active-light-primary me-2">
                            @lang('common.cancel')
                        </a>
                        <button type="submit" class="btn btn-primary" id="kt_document_submit">
                            <span class="indicator-label">{{ __('documents.update_document') }}</span>
