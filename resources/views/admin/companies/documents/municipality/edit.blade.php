...
@section('title', __('companies.edit_municipality_license') . ' - ' . $municipalityLicense->license_number)
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    {{ __('companies.edit_municipality_license') }}
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{ __('companies.edit_municipality_license') }}</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title-->
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <!--begin::Card title-->
                    <div class="card-title fs-3 fw-bold">{{ __('companies.edit_municipality_license') }} - {{ $municipalityLicense->license_number }}</div>
                    <!--end::Card title-->
                </div>
                <!--end::Card header-->

                <!--begin::Form-->
                <form id="kt_municipality_form" class="form" action="{{ route('admin.companies.municipality-licenses.update', [$company, $municipalityLicense]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!--begin::Card body-->
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('license_number') is-invalid @enderror"
                                               name="license_number" value="{{ old('license_number', $municipalityLicense->license_number) }}" />
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('municipality_name') is-invalid @enderror"
                                               name="municipality_name" value="{{ old('municipality_name', $municipalityLicense->municipality_name) }}" />
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <select class="form-select form-select-solid @error('license_type') is-invalid @enderror" name="license_type">
                                            ...
                                            <option value="commercial" @selected(old('license_type', $municipalityLicense->license_type) == 'commercial')>{{ __('companies.commercial_license') }}</option>
                                            <option value="industrial" @selected(old('license_type', $municipalityLicense->license_type) == 'industrial')>{{ __('companies.industrial_license') }}</option>
                                            <option value="residential" @selected(old('license_type', $municipalityLicense->license_type) == 'residential')>{{ __('companies.residential_license') }}</option>
                                            <option value="construction" @selected(old('license_type', $municipalityLicense->license_type) == 'construction')>{{ __('companies.construction_license') }}</option>
                                            <option value="demolition" @selected(old('license_type', $municipalityLicense->license_type) == 'demolition')>{{ __('companies.demolition_license') }}</option>
                                            <option value="advertising" @selected(old('license_type', $municipalityLicense->license_type) == 'advertising')>{{ __('companies.advertising_license') }}</option>
                                            <option value="event" @selected(old('license_type', $municipalityLicense->license_type) == 'event')>{{ __('companies.event_license') }}</option>
                                            <option value="other" @selected(old('license_type', $municipalityLicense->license_type) == 'other')>{{ __('companies.other') }}</option>
                                        </select>
                                        @error('license_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <select class="form-select form-select-solid @error('land_use_type') is-invalid @enderror" name="land_use_type">
                                            ...
                                            <option value="commercial" @selected(old('land_use_type', $municipalityLicense->land_use_type) == 'commercial')>{{ __('companies.commercial') }}</option>
                                            <option value="industrial" @selected(old('land_use_type', $municipalityLicense->land_use_type) == 'industrial')>{{ __('companies.industrial') }}</option>
                                            <option value="residential" @selected(old('land_use_type', $municipalityLicense->land_use_type) == 'residential')>{{ __('companies.residential') }}</option>
                                            <option value="mixed" @selected(old('land_use_type', $municipalityLicense->land_use_type) == 'mixed')>{{ __('companies.mixed_use') }}</option>
                                            <option value="administrative" @selected(old('land_use_type', $municipalityLicense->land_use_type) == 'administrative')>{{ __('companies.administrative') }}</option>
                                            <option value="educational" @selected(old('land_use_type', $municipalityLicense->land_use_type) == 'educational')>{{ __('companies.educational') }}</option>
                                            <option value="health" @selected(old('land_use_type', $municipalityLicense->land_use_type) == 'health')>{{ __('companies.health_services') }}</option>
                                            <option value="recreational" @selected(old('land_use_type', $municipalityLicense->land_use_type) == 'recreational')>{{ __('companies.recreational') }}</option>
                                        </select>
                                        @error('land_use_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="date" class="form-control form-control-solid @error('issue_date') is-invalid @enderror"
                                               name="issue_date" value="{{ old('issue_date', $municipalityLicense->issue_date?->format('Y-m-d')) }}" />
                                        @error('issue_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="date" class="form-control form-control-solid @error('expiry_date') is-invalid @enderror"
                                               name="expiry_date" value="{{ old('expiry_date', $municipalityLicense->expiry_date?->format('Y-m-d')) }}" />
                                        @error('expiry_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('location_code') is-invalid @enderror"
                                               name="location_code" value="{{ old('location_code', $municipalityLicense->location_code) }}" />
                                        @error('location_code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="number" min="0" step="0.01" class="form-control form-control-solid @error('area') is-invalid @enderror"
                                               name="area" value="{{ old('area', $municipalityLicense->area) }}" />
                                        @error('area')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('zone_classification') is-invalid @enderror"
                                               name="zone_classification" value="{{ old('zone_classification', $municipalityLicense->zone_classification) }}" />
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('building_permit_number') is-invalid @enderror"
                                               name="building_permit_number" value="{{ old('building_permit_number', $municipalityLicense->building_permit_number) }}" />
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="number" min="0" step="0.01" class="form-control form-control-solid @error('license_fees') is-invalid @enderror"
                                               name="license_fees" value="{{ old('license_fees', $municipalityLicense->license_fees) }}" />
                                        @error('license_fees')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <div class="form-text">
                                            @if($municipalityLicense->certificate_file_path)
                                                ...
                                                <a href="{{ asset('storage/' . $municipalityLicense->certificate_file_path) }}"
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid @error('activity_desc') is-invalid @enderror"
                                                  name="activity_desc" rows="3">{{ old('activity_desc', $municipalityLicense->activity_desc) }}</textarea>
                                        @error('activity_desc')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid @error('conditions') is-invalid @enderror"
                                                  name="conditions" rows="3">{{ old('conditions', $municipalityLicense->conditions) }}</textarea>
                                        @error('conditions')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row g-9">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid @error('notes') is-invalid @enderror"
                                                  name="notes" rows="3">{{ old('notes', $municipalityLicense->notes) }}</textarea>
                                        @error('notes')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <a href="{{ route('admin.companies.municipality-licenses.show', [$company, $municipalityLicense]) }}" class="btn btn-light btn-active-light-primary me-2">
                            @lang('common.cancel')
                        </a>
...
// Class definition
var KTMunicipalityEdit = function () {
    // Elements
    var form;
    var submitButton;
