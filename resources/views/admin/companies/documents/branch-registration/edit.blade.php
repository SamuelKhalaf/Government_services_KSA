...
@section('title', __('companies.edit_branch_registration') . ' - ' . $branchRegistration->branch_reg_number)
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    {{ __('companies.edit_branch_registration') }}
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{ __('companies.edit_branch_registration') }}</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title-->
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <!--begin::Card title-->
                    <div class="card-title fs-3 fw-bold">{{ __('companies.edit_branch_registration') }} - {{ $branchRegistration->branch_reg_number }}</div>
                    <!--end::Card title-->
                </div>
                <!--end::Card header-->

                <!--begin::Form-->
                <form id="kt_branch_form" class="form" action="{{ route('admin.companies.branch-registrations.update', [$company, $branchRegistration]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!--begin::Card body-->
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('branch_reg_number') is-invalid @enderror"
                                               name="branch_reg_number" value="{{ old('branch_reg_number', $branchRegistration->branch_reg_number) }}" />
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('parent_cr_number') is-invalid @enderror"
                                               name="parent_cr_number" value="{{ old('parent_cr_number', $branchRegistration->parent_cr_number) }}" />
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <select class="form-select form-select-solid @error('branch_type') is-invalid @enderror" name="branch_type">
                                            ...
                                            <option value="main_branch" @selected(old('branch_type', $branchRegistration->branch_type) == 'main_branch')>{{ __('companies.main_branch') }}</option>
                                            <option value="sub_branch" @selected(old('branch_type', $branchRegistration->branch_type) == 'sub_branch')>{{ __('companies.sub_branch') }}</option>
                                            <option value="regional_office" @selected(old('branch_type', $branchRegistration->branch_type) == 'regional_office')>{{ __('companies.regional_office') }}</option>
                                            <option value="representative_office" @selected(old('branch_type', $branchRegistration->branch_type) == 'representative_office')>{{ __('companies.representative_office') }}</option>
                                            <option value="sales_office" @selected(old('branch_type', $branchRegistration->branch_type) == 'sales_office')>{{ __('companies.sales_office') }}</option>
                                            <option value="warehouse" @selected(old('branch_type', $branchRegistration->branch_type) == 'warehouse')>{{ __('companies.warehouse') }}</option>
                                            <option value="other" @selected(old('branch_type', $branchRegistration->branch_type) == 'other')>{{ __('companies.other') }}</option>
                                        </select>
                                        @error('branch_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <select class="form-select form-select-solid @error('legal_form') is-invalid @enderror" name="legal_form">
                                            ...
                                            <option value="LLC" @selected(old('legal_form', $branchRegistration->legal_form) == 'LLC')>{{ __('companies.limited_liability_company_llc') }}</option>
                                            <option value="JSC" @selected(old('legal_form', $branchRegistration->legal_form) == 'JSC')>{{ __('companies.joint_stock_company_jsc') }}</option>
                                            <option value="Partnership" @selected(old('legal_form', $branchRegistration->legal_form) == 'Partnership')>{{ __('companies.partnership') }}</option>
                                            <option value="Sole_Proprietorship" @selected(old('legal_form', $branchRegistration->legal_form) == 'Sole_Proprietorship')>{{ __('companies.sole_proprietorship') }}</option>
                                            <option value="Branch_Office" @selected(old('legal_form', $branchRegistration->legal_form) == 'Branch_Office')>{{ __('companies.branch_office') }}</option>
                                            <option value="Representative_Office" @selected(old('legal_form', $branchRegistration->legal_form) == 'Representative_Office')>{{ __('companies.representative_office') }}</option>
                                        </select>
                                        @error('legal_form')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="date" class="form-control form-control-solid @error('registration_date') is-invalid @enderror"
                                               name="registration_date" value="{{ old('registration_date', $branchRegistration->registration_date?->format('Y-m-d')) }}" />
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="number" min="0" step="0.01" class="form-control form-control-solid @error('authorized_capital') is-invalid @enderror"
                                               name="authorized_capital" value="{{ old('authorized_capital', $branchRegistration->authorized_capital) }}" />
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="date" class="form-control form-control-solid @error('issue_date') is-invalid @enderror"
                                               name="issue_date" value="{{ old('issue_date', $branchRegistration->issue_date?->format('Y-m-d')) }}" />
                                        @error('issue_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="date" class="form-control form-control-solid @error('expiry_date') is-invalid @enderror"
                                               name="expiry_date" value="{{ old('expiry_date', $branchRegistration->expiry_date?->format('Y-m-d')) }}" />
                                        @error('expiry_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('issuing_authority') is-invalid @enderror"
                                               name="issuing_authority" value="{{ old('issuing_authority', $branchRegistration->issuing_authority) }}" />
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('manager_name') is-invalid @enderror"
                                               name="manager_name" value="{{ old('manager_name', $branchRegistration->manager_name) }}" />
                                        @error('manager_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('manager_id_number') is-invalid @enderror"
                                               name="manager_id_number" value="{{ old('manager_id_number', $branchRegistration->manager_id_number) }}" />
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('manager_nationality') is-invalid @enderror"
                                               name="manager_nationality" value="{{ old('manager_nationality', $branchRegistration->manager_nationality) }}" />
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('manager_position') is-invalid @enderror"
                                               name="manager_position" value="{{ old('manager_position', $branchRegistration->manager_position) }}" />
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid @error('branch_activity') is-invalid @enderror"
                                                  name="branch_activity" rows="3">{{ old('branch_activity', $branchRegistration->branch_activity) }}</textarea>
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid @error('activities_list') is-invalid @enderror"
                                                  name="activities_list" rows="3">{{ old('activities_list', $branchRegistration->activities_list) }}</textarea>
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <div class="form-text">
                                            @if($branchRegistration->certificate_file_path)
                                                ...
                                                <a href="{{ asset('storage/' . $branchRegistration->certificate_file_path) }}"
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid @error('notes') is-invalid @enderror"
                                                  name="notes" rows="4">{{ old('notes', $branchRegistration->notes) }}</textarea>
                                        @error('notes')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row g-9">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        <div class="form-check form-switch form-check-custom form-check-solid">
                                            <input class="form-check-input" type="checkbox" name="enable_reminder"
                                                   id="enable_reminder" value="1" @checked(old('enable_reminder', $branchRegistration->enable_reminder)) />
                                    ...
                                    <div class="col-md-6 fv-row" id="reminder_days_field">
                                        ...
                                        <input type="number" min="1" max="365" class="form-control form-control-solid @error('reminder_days') is-invalid @enderror"
                                               name="reminder_days" value="{{ old('reminder_days', $branchRegistration->reminder_days ?? 30) }}" />
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <a href="{{ route('admin.companies.branch-registrations.show', [$company, $branchRegistration]) }}" class="btn btn-light btn-active-light-primary me-2">
                            @lang('common.cancel')
                        </a>
                        <button type="submit" class="btn btn-primary" id="kt_branch_submit">
                            <span class="indicator-label">{{ __('companies.update_registration') }}</span>
