...
<div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{ __('tasks.create_task') }}</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title-->
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <!--begin::Form-->
            <form id="kt_task_create_form" class="form" method="POST" action="{{ route('admin.tasks.store') }}">
                @csrf
                <!--begin::Card-->
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-body border-0 p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="title" class="form-control form-control-lg form-control-solid @error('title') is-invalid @enderror" 
                                       placeholder="{{ __('tasks.enter_task_title') }}" value="{{ old('title') }}" />
                                @error('title')
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <textarea name="description" class="form-control form-control-lg form-control-solid @error('description') is-invalid @enderror" 
                                          rows="3" placeholder="{{ __('tasks.enter_task_description') }}">{{ old('description') }}</textarea>
                                @error('description')
                                <div class="fv-plugins-message-container">
                                    <div class="fv-help-block">{{ $message }}</div>
                                </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <select name="assigned_to" id="assigned_to_select" class="form-select form-select-solid @error('assigned_to') is-invalid @enderror" data-control="select2" data-placeholder="{{ __('tasks.select_assigned_user') }}">
                                    <option></option>
                                </select>
                                @error('assigned_to')
                                <div class="fv-plugins-message-container">
                ...
                <!--begin::Document Selection Card-->
                <div class="card mb-5 mb-xl-10">
                    <!--begin::Card header-->
                    <div class="card-header border-0 cursor-pointer">
                        <!--begin::Card title-->
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">{{ __('tasks.document_selection') }}</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--end::Card header-->
                    ...
                    <div class="card-body border-0 p-9">
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">{{ __('tasks.document_type') }}</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8">
                        ...
                        <div class="row mb-6" id="company_selection_row" style="display: none;">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">{{ __('tasks.client') }}</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8">
                        ...
                        <div class="row mb-6" id="employee_selection_row" style="display: none;">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">{{ __('tasks.employee_selection') }}</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8">
                        ...
                        <div class="row mb-6" id="document_selection_row" style="display: none;">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">{{ __('tasks.document') }}</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8">
                ...
                <!--end::Document Selection Card-->
                @endif

                <!--begin::Actions-->
                <div class="card">
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <a href="{{ route('admin.tasks.index') }}" class="btn btn-light btn-active-light-primary me-2">{{ __('common.cancel') }}</a>
                        <button type="submit" class="btn btn-primary" id="kt_task_create_submit">
                            <span class="indicator-label">{{ __('tasks.create_task') }}</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.getElementById('kt_task_create_form');
    
    let selectedDocuments = [];
    let availableEmployees = [];

    // Load employees for assignment on page load
    ...
    form.addEventListener('submit', function(e) {
        if (selectedDocuments.length === 0) {
            e.preventDefault();
            alert('{{ __("tasks.documents_required") }}');
            return false;
        }
        ...
        fetch('{{ route("admin.tasks.ajax.employees-for-assignment") }}')
            ...
            .then(employees => {
                ...
                employees.forEach(employee => {
                    assignedToSelect.append(new Option(employee.name, employee.id));
                });
