...
class StoreEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'national_id' => 'required_if:type,saudi|nullable|string|max:255|unique:employees,national_id',
            ...
            'iqama_number' => 'required_if:type,expat|nullable|string|max:255|unique:employees,iqama_number',
            ...
            'passport_number' => 'required_if:type,expat|nullable|string|max:255|unique:employees,passport_number',
