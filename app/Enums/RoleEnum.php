...
enum RoleEnum: string
{
    ...
    public function getDescription(string $lang = 'en'): string
    {
        return match($this) {
            self::ADMIN => $lang === 'ar'
                ? 'صلاحيات كاملة لإدارة النظام والمستخدمين والمنشأت والوثائق والمهام والحزم المالية'
                : 'Full system access to manage users, clients, documents, tasks, and financial packages',
            self::EMPLOYEE => $lang === 'ar'
                ? 'صلاحيات محدودة لإدارة المنشأت المخصصين وتحديث الوثائق والمهام المكلف بها فقط'
